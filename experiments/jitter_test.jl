...
"""
Jitter test — how much spike-timestamp jitter can each NeuroPulse kernel
...
function _summary_header(io)
    println(io, "# Jitter test — timing tolerance of the NeuroPulse kernels")
    println(io)
    ...
    println(io, "## Question")
    println(io)
    println(io, "How quickly does NeuroPulse lose target selectivity as spike timestamps are ",
