...
- Import TemporalFocus.jl attention surface as `NeuroPulse.Attention`
...
- Rename the Julia package and loadable module from `TemporalFocus` to `NeuroPulse` while
  preserving the canonical UUID and public API.
